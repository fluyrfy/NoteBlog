    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary rounded-top">
      <div class="container d-flex flex-nowrap" id="top-left">
        ...
        <div class="d-flex">
          <input
            ...
            aria-label="Search"
            v-model="searchWords"
            v-if="$store.getters.getListActive !== true"
          />
      ...
      <div class="collapse navbar-collapse row mr-3" id="navbarSupported">
        <div class="mb-2 mb-lg-0 col-8">
          <routerLink class="" to="/write"
            >撰寫<i class="fas fa-pencil-alt"></i
          ></routerLink>
        </div>
        <div class="dropdown col-3">
          ...
          <ul class="dropdown-menu ml-3" aria-labelledby="user">
            <template v-if="$store.getters.getsUid == 0">
              <li>
                <routerLink class="dropdown-item" to="/signin">登入</routerLink>
              </li>
              <li>
                <routerLink class="dropdown-item" to="/signup">註冊</routerLink>
              </li>
            </template>
            ...
            <template v-if="$store.getters.getsUid !== 0">
              ...
              <li>
                <button class="dropdown-item" @click="signout">登出</button>
              </li>
            </template>
          </ul>
        </div>
