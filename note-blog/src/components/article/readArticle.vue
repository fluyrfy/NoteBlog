          ...
          <article>
            ...
            <header class="mb-4">
              ...
              <routerLink
                ...
                to="/"
                ><span @click="keyWord">{{ category }}</span></routerLink
              >
            </header>
              ...
              <div class="card-body" v-if="isRouterAlive">
                ...
                <div class="mb-4 d-flex flex-column">
                  <textarea
                    class="form-control"
                    rows="3"
                    placeholder="加入討論和留下寶貴的意見!"
                    v-model="comment"
                  ></textarea
                  ><button
                    type=""
                    class="btn btn-primary mt-1 align-self-lg-end"
                    @click="addComment"
                  >
                    留言
                  </button>
                ...
                <div v-for="(item1, index1) of aInfo" :key="index1">
                  <div v-if="item1.parentcmtid == 0" class="d-flex mb-4 row">
                    <!-- Parent comment-->
                    <div class="flex-shrink-0 col-lg-1 ms-3">
                      <img
                        width="50px"
                        height="50px"
                    ...
                    <div class="col-lg-10">
                      ...
                      <div class="d-flex justify-content-lg-between">
                        {{ item1.cmtcontent
                          ...
                          @click="showCommentTextArea(item1.commentid)"
                          href="javascript:void(0)"
                          class="text-muted"
                          >回覆</a
                        >
                      ...
                      >
                        ...
                        ><button
                          type=""
                          class="btn btn-primary mt-1 align-self-lg-end"
                          @click="addChildComment(item1.commentid)"
                        >
                          留言
                        </button>
                      </div>
                      ...
                      <div v-for="(item2, index2) of aInfo" :key="index2">
                        <div
                          v-if="item2.parentcmtid == item1.commentid"
                          class="d-flex mt-4"
                        >
